...
class SeriesFolderCSVDataset:
    ...
    def _read_csv(self) -> Tuple[np.ndarray, Optional[np.ndarray]]:
        ...
        data, _ = opp_sliding_window(data, original_data["standard activity code"].values, self.window, self.overlap)
